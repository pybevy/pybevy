...
#[pycomponent(Atmosphere, bridge, no_reflect, view_only_fields = [inner_radius: f32, outer_radius: f32])]
#[pyclass(name = "Atmosphere", module = "pybevy.light", extends = PyComponent)]
