...
class Color:
    """A color represented by one of Bevy's supported color spaces.
    ...
    def __init__(self) -> None:
        """Create the default white linear color."""

    # sRGB constructors
    @staticmethod
    def srgb_u8(red: int, green: int, blue: int) -> Color.Srgba: ...
    @staticmethod
    def srgba_u8(red: int, green: int, blue: int, alpha: int) -> Color.Srgba: ...
    @staticmethod
    def srgb_u32(color: int) -> Color.Srgba: ...
    @staticmethod
    def srgba_u32(color: int) -> Color.Srgba: ...
    @staticmethod
    def srgb(red: float, green: float, blue: float) -> Color.Srgba: ...
    @staticmethod
    def srgba(red: float, green: float, blue: float, alpha: float) -> Color.Srgba: ...
    @staticmethod
    def srgb_from_array(array: tuple[float, float, float]) -> Color.Srgba: ...

    # Linear RGB constructors
    @staticmethod
    def linear_rgb(red: float, green: float, blue: float) -> Color.LinearRgba: ...
    @staticmethod
    def linear_rgba(
    ...
    # HSL constructors
    @staticmethod
    def hsl(hue: float, saturation: float, lightness: float) -> Color.Hsla: ...
    @staticmethod
    def hsla(
    ...
    # HSV constructors
    @staticmethod
    def hsv(hue: float, saturation: float, value: float) -> Color.Hsva: ...
    @staticmethod
    def hsva(
    ...
    # HWB constructors
    @staticmethod
    def hwb(hue: float, whiteness: float, blackness: float) -> Color.Hwba: ...
    @staticmethod
    def hwba(
        hue: float, whiteness: float, blackness: float, alpha: float
    ) -> Color.Hwba: ...

    # LAB constructors
    @staticmethod
    def lab(lightness: float, a: float, b: float) -> Color.Laba: ...
    @staticmethod
    def laba(lightness: float, a: float, b: float, alpha: float) -> Color.Laba: ...

    # LCH constructors
    @staticmethod
    def lch(lightness: float, chroma: float, hue: float) -> Color.Lcha: ...
    @staticmethod
    def lcha(
        lightness: float, chroma: float, hue: float, alpha: float
    ) -> Color.Lcha: ...

    # Oklab constructors
    @staticmethod
    def oklab(lightness: float, a: float, b: float) -> Color.Oklaba: ...
    @staticmethod
    def oklaba(lightness: float, a: float, b: float, alpha: float) -> Color.Oklaba: ...

    # Oklch constructors
    @staticmethod
    def oklch(lightness: float, chroma: float, hue: float) -> Color.Oklcha: ...
    @staticmethod
    def oklcha(
        lightness: float, chroma: float, hue: float, alpha: float
    ) -> Color.Oklcha: ...
    ...
    # XYZ constructors
    @staticmethod
    def xyz(x: float, y: float, z: float) -> Color.Xyza: ...
    @staticmethod
    def xyza(x: float, y: float, z: float, alpha: float) -> Color.Xyza: ...

    # Conversion methods
    def to_linear(self) -> pybevy.color.LinearRgba: ...
    def to_srgba(self) -> pybevy.color.Srgba: ...
    ...
    def try_interpolate_stable(self, other: Color, t: float) -> Color:
        """Interpolate equal color-space variants; raise ValueError when variants differ."""
...
class LinearRgba:
    ...
    @staticmethod
    def from_f32_array(
        color: list[float] | tuple[float, float, float, float],
    ) -> LinearRgba:
...
class Srgba:
    ...
    def to_vec3(self) -> Vec3:
        """Convert to Vec3(r, g, b) without alpha."""
    @staticmethod
    def from_f32_array(color: list[float] | tuple[float, float, float, float]) -> Srgba:
        """Create from [r, g, b, a] float array."""
    @staticmethod
    def from_f32_array_no_alpha(
        color: list[float] | tuple[float, float, float],
...
class Hsla:
    ...
    def to_f32_array_no_alpha(self) -> list[float]: ...
    @staticmethod
    def from_f32_array(color: list[float] | tuple[float, float, float, float]) -> Hsla: ...
    @staticmethod
...
class Oklcha:
    ...
    def to_f32_array_no_alpha(self) -> list[float]: ...
    @staticmethod
    def from_f32_array(color: list[float] | tuple[float, float, float, float]) -> Oklcha: ...
    @staticmethod
...
class Lcha:
    ...
    def to_f32_array_no_alpha(self) -> list[float]: ...
    @staticmethod
    def from_f32_array(color: list[float] | tuple[float, float, float, float]) -> Lcha: ...
    @staticmethod
...
class Hsva:
    ...
    def to_f32_array_no_alpha(self) -> list[float]: ...
    @staticmethod
    def from_f32_array(color: list[float] | tuple[float, float, float, float]) -> Hsva: ...
    @staticmethod
...
class Hwba:
    ...
    def with_whiteness(self, whiteness: float) -> Hwba: ...
    def with_blackness(self, blackness: float) -> Hwba: ...
    def with_alpha(self, alpha: float) -> Hwba: ...
    def set_alpha(self, alpha: float) -> None: ...
    def is_fully_transparent(self) -> bool: ...
    def is_fully_opaque(self) -> bool: ...
    def mix(self, other: Hwba, factor: float) -> Hwba: ...
    def mix_assign(self, other: Hwba, factor: float) -> None: ...
    def to_linear(self) -> LinearRgba: ...
    def to_srgba(self) -> Srgba: ...
    def to_f32_array(self) -> list[float]: ...
    def to_f32_array_no_alpha(self) -> list[float]: ...
    ...
    def to_vec3(self) -> Vec3: ...
    @staticmethod
    def from_vec4(color: Vec4) -> Hwba: ...
    @staticmethod
    def from_vec3(color: Vec3) -> Hwba: ...
...
class Laba:
    ...
    @staticmethod
    def from_f32_array(color: list[float]) -> Laba: ...
    @staticmethod
    def from_f32_array_no_alpha(
        color: list[float] | tuple[float, float, float],
    ) -> Laba:
...
class Oklaba:
    ...
    def to_f32_array_no_alpha(self) -> list[float]:
        """Convert to [l, a, b] float array without alpha."""
    @staticmethod
    def from_f32_array(color: list[float]) -> Oklaba: ...
    @staticmethod
    def from_f32_array_no_alpha(
        color: list[float] | tuple[float, float, float],
    ) -> Oklaba:
...
class Xyza:
    ...
    @staticmethod
    def from_f32_array(color: list[float]) -> Xyza: ...
    @staticmethod
    def from_f32_array_no_alpha(
        color: list[float] | tuple[float, float, float],
    ) -> Xyza:
