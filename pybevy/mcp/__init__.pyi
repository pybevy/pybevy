...
class ApiIndex:
    """Pre-built index of PyBevy's documented public API.

    Provides search, type lookup, and guide access from public stubs and
    explicitly re-exported pure-Python modules.
    ...
    def suggest_type_names(self, type_name: str) -> list[str]: ...
