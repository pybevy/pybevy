...
class ActiveAnimation:
    ...
    def elapsed(self) -> float:
        """Unpaused tick time accumulated before completion; replay resets it."""
    @property
    ...
    def seek_time(self) -> float:
        """Current position in the clip; manual seeks are not clamped immediately."""
...
class AnimationGraph(Asset):
    def __copy__(self) -> AnimationGraph: ...
    def __deepcopy__(self, memo: dict[int, object]) -> AnimationGraph: ...
    def __init__(self) -> None: ...
    @staticmethod
    def from_clip(
    ...
    @root.setter
    def root(self, value: AnimationNodeIndex) -> None: ...
    def add_blend(
...
class AnimationGraphNode:
    ...
    @node_type.setter
    def node_type(self, value: AnimationNodeType) -> None: ...
    @property
    def mask(self) -> int: ...
    @mask.setter
...
class AnimationClip(Asset):
    ...
    """
    def __copy__(self) -> AnimationClip: ...
    def __deepcopy__(self, memo: dict[int, object]) -> AnimationClip: ...
    def __init__(self) -> None: ...
