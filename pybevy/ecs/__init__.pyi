...
class Component:
    ...
    def batch(**kwargs: object) -> Batchable:
        """Create a batch from lists, pybevy arrays, or optional NumPy arrays.
...
class ViewColumn:
    ...
    def round(self) -> ViewColumn:
        """Round ties to even, unlike glam-backed Vec2/Vec3/Vec4.round()."""
    ...
    def fract(self) -> ViewColumn:
        """Signed fraction x - trunc(x); negative inputs can return negative values."""
