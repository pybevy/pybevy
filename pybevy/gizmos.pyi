...
class GizmoLineJoint:
    ...
    def __copy__(self) -> GizmoLineJoint: ...
    def __deepcopy__(self, memo: dict[int, object]) -> GizmoLineJoint: ...
...
class GizmoLineStyle:
    ...
    def __copy__(self) -> GizmoLineStyle: ...
    def __deepcopy__(self, memo: dict[int, object]) -> GizmoLineStyle: ...
