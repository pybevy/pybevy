...
class SphereMeshBuilder(Meshable):
    def build(self) -> Mesh: ...
    def kind(self) -> SphereKind: ...
    def ico(self, subdivisions: int) -> Mesh: ...
    def uv(self, sectors: int, stacks: int) -> Mesh: ...

class Plane3dMeshBuilder(MeshBuilder):
    @staticmethod
    def new(normal: Dir3, size: Vec2) -> Plane3dMeshBuilder: ...
    @staticmethod
    def from_size(size: Vec2) -> Plane3dMeshBuilder: ...
    @staticmethod
    def from_length(length: float) -> Plane3dMeshBuilder: ...
    def normal(self, normal: Dir3) -> Plane3dMeshBuilder: ...
    def size(self, width: float, height: float) -> Plane3dMeshBuilder: ...
    def subdivisions(self, subdivisions: int) -> Plane3dMeshBuilder: ...
    def build(self) -> Mesh: ...
