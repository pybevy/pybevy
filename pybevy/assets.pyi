...
class RenderAssetUsages:
    ...
    def __copy__(self) -> RenderAssetUsages: ...
    def insert(self, other: RenderAssetUsages) -> None: ...
    def remove(self, other: RenderAssetUsages) -> None: ...
    def toggle(self, other: RenderAssetUsages) -> None: ...
    def set(self, other: RenderAssetUsages, value: bool) -> None: ...
